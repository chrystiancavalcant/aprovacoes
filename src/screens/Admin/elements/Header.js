        ...
        <nav className="navbar navbar-default">
         <div className="container-fluid">
          <div className="navbar-header">
           ...
           <a className="navbar-brand" href="/"><i className="fab fa-instagram"></i>FromRio</a>
          </div>
          ...
          <div className="navbar-right">                          
           <ul className="nav navbar-nav">
             ...
             <li className="dropdown notification-list">
              <a className="nav-link dropdown-toggle" data-toggle="dropdown" href="/" role="button" aria-haspopup="false" aria-expanded="false">
               ...
               <span className="badge badge-danger badge-pill noti-icon-badge">1</span>
              </a>
              <div className="dropdown-menu dropdown-menu-right dropdown-lg">
               <div className="dropdown-item noti-title">
                <h6 className="m-0">
                 <span className="pull-right">
                  <a href="/" className="text-dark"><small>Apagar tudo</small></a> 
                 </span>Notificação
                </h6>
               </div>
             ...
             <li className="dropdown notification-list">
              <a className="nav-link dropdown-toggle arrow-none waves-effect" data-toggle="dropdown" href="/" role="button" aria-haspopup="false" aria-expanded="false">
               ...
               <span className="badge badge-success badge-pill noti-icon-badge">1</span>
              </a>
           ...
           <li className="dropdown mega-avatar">
            ...
            <div className="dropdown-menu w dropdown-menu-scale pull-right">
             <a className="dropdown-item" href="/"><span>Minha Conta</span></a> 
             <a className="dropdown-item" href="/"><span>Alterar Senha</span></a> 
